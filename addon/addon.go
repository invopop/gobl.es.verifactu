...
// codeVeriFactu namespaces every fault this addon reports. Both modalities
// share it: invoice processing is identical under VERI*FACTU and NO VERI*FACTU,
// so a namespace per modality would imply a split the invoice rules do not
// have. The set component already says which rules rejected the document,
// BILL-INVOICE or BILL-STATUS.
const codeVeriFactu rules.Code = "ES-VERIFACTU"
