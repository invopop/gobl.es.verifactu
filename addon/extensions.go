...
// Event Type Codes from the L2E list, used as the `TipoEvento` of a
// `RegistroEvento` in the NO VERI*FACTU modality.
const (
	CodeSystemStartup        cbc.Code = "01" // Invoicing system startup
	CodeSystemShutdown       cbc.Code = "02" // Invoicing system shutdown
	CodeInvoiceAnomalyLaunch cbc.Code = "03" // Invoice record anomaly detection launch
	CodeInvoiceAnomaly       cbc.Code = "04" // Invoice record anomaly detection
	CodeEventAnomalyLaunch   cbc.Code = "05" // Event record anomaly detection launch
	CodeEventAnomaly         cbc.Code = "06" // Event record anomaly detection
	CodeBackupRestoration    cbc.Code = "07" // Backup restoration
	CodeInvoiceExport        cbc.Code = "08" // Invoice record export
	CodeEventExport          cbc.Code = "09" // Event record export
	CodeEventSummary         cbc.Code = "10" // Event summary
	CodeOther                cbc.Code = "90" // Other
)
...
// extEventType carries the L2E event type of a NO VERI*FACTU status line.
// Named so the status rules can read its codes directly.
var extEventType = &cbc.Definition{
	Key: ExtKeyEventType,
	Name: i18n.String{
		i18n.EN: "Event Type Code",
		i18n.ES: "Tipo de Evento",
	},
	Desc: i18n.String{
		i18n.EN: here.Doc(`
			Identifies the NO VERI*FACTU event being reported by a ~bill.Status~
			line, whose key must be ~other~. Core GOBL status line keys describe
			the situation of a business document, so the event type is carried
			here instead.

			Maps to the ~TipoEvento~ field of a ~RegistroEvento~, list L2E.
		`),
	},
	Values: []*cbc.Definition{
		{
			Code: CodeSystemStartup,
			Name: i18n.String{
				i18n.EN: "Invoicing System Startup",
				i18n.ES: "Sistema Informático de Facturación - Inicio",
			},
		},
		{
			Code: CodeSystemShutdown,
			Name: i18n.String{
				i18n.EN: "Invoicing System Shutdown",
				i18n.ES: "Sistema Informático de Facturación - Fin",
			},
		},
		{
			Code: CodeInvoiceAnomalyLaunch,
			Name: i18n.String{
				i18n.EN: "Invoice Record Anomaly Detection Launch",
				i18n.ES: "Lanzamiento Proceso de Detección de Anomalías en Registros de Facturación",
			},
		},
		{
			Code: CodeInvoiceAnomaly,
			Name: i18n.String{
				i18n.EN: "Invoice Record Anomaly Detection",
				i18n.ES: "Detección de Anomalías en Registros de Facturación",
			},
		},
		{
			Code: CodeEventAnomalyLaunch,
			Name: i18n.String{
				i18n.EN: "Event Record Anomaly Detection Launch",
				i18n.ES: "Lanzamiento Proceso de Detección de Anomalías en Registros de Evento",
			},
		},
		{
			Code: CodeEventAnomaly,
			Name: i18n.String{
				i18n.EN: "Event Record Anomaly Detection",
				i18n.ES: "Detección de Anomalías en Registros de Evento",
			},
		},
		{
			Code: CodeBackupRestoration,
			Name: i18n.String{
		...
		{
			Code: CodeInvoiceExport,
			Name: i18n.String{
				i18n.EN: "Invoice Record Export",
				i18n.ES: "Exportación de Registros de Facturación",
			},
		},
		{
			Code: CodeEventExport,
			Name: i18n.String{
				i18n.EN: "Event Record Export",
				i18n.ES: "Exportación de Registros de Evento",
			},
		},
		{
			Code: CodeEventSummary,
			Name: i18n.String{
				i18n.EN: "Event Summary",
				i18n.ES: "Resumen de Eventos",
			},
		},
		{
			Code: CodeOther,
